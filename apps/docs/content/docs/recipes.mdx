...
content; a tooltip on *measured, wrapping* text is the one case that still
wants the deprecated [`@wingleeio/mugen-ui`](https://www.npmjs.com/package/@wingleeio/mugen-ui)
