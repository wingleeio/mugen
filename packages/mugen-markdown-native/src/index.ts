...
// Opt-in native single-view text block (NATIVE-TEXT.md). Off by default; the
// consumer injects the component from @wingleeio/pretext-core/text-block:
//   import { MugenTextBlock } from '@wingleeio/pretext-core/text-block';
//   setMugenTextBlock(MugenTextBlock);
export {
  setMugenTextBlock,
  isMugenTextBlockEnabled,
  type BlockComponent as MugenTextBlockComponent,
